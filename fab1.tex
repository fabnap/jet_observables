...
\begin{figure}[!ht]
  \centering
      \includegraphics[width=0.9\textwidth]{~/GitHub/jet_observables_note/jet_part/grooming/Figura_4.png}
...
\begin{figure}[!ht]
  \centering
      \includegraphics[width=0.7\textwidth]{~/GitHub/jet_observables_note/jet_part/trackandcalo.png}
...
\begin{figure}[!ht]
  \centering
      \includegraphics[width=0.55\textwidth]{~/GitHub/jet_observables_note/jet_part/search.png}
...
\begin{figure}[!ht]
  \centering
      \includegraphics[width=0.9\textwidth]{~/GitHub/jet_observables_note/jet_part/wrongsigma.png}
...
\begin{figure}[!ht]
  \centering
      \includegraphics[width=0.7\textwidth]{~/GitHub/jet_observables_note/jet_part/8ResponsePTJ_h_JetRatio_mJ05CALO.pdf}
